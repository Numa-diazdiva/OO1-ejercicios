...
public class JobSchedulerTest {
    ...
    private JobScheduler newPriorityScheduler() {
    	JobScheduler priorityScheduler = new HighestPriorityScheduler();
    ...
    @Test
    void testSchedule() {
    	// Since the schedule method is only defined in the abstract superclass, this method can be tested using any of its children
    	JobScheduler aScheduler = new FIFOScheduler();
    ...
    @Test
    void testUnschedule() {
    	JobScheduler aScheduler = new LIFOScheduler();
